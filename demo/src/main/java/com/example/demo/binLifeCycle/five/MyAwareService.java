...
public class MyAwareService implements ApplicationContextAware, ApplicationEventPublisherAware, BeanClassLoaderAware, BeanFactoryAware, BeanNameAware, EnvironmentAware, ResourceLoaderAware, ImportAware {
    ...
    public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        ...
        System.out.println("setBeanFactory:: employee1 bean singleton=" + beanFactory.isSingleton("employee1"));
        System.out.println("setBeanFactory:: employee2 bean singleton=" + beanFactory.isSingleton("employee2"));
        System.out.println("setBeanFactory:: employee3 bean singleton=" + beanFactory.isSingleton("employee3"));
    }

    @Override
    public void setBeanName(String s) {
        System.out.println("setBeanName called");
        System.out.println("setBeanName:: Bean Name defined in context=" + s);
    }
