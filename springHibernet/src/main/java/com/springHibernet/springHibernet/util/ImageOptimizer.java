package com.springHibernet.springHibernet.util;
...
public class ImageOptimizer {
    public void optimizeImage(String UPLOADE_FOLDER, MultipartFile file, float quality, int width, int height) throws IOException {
        MultipartFile multipartFile = null;
        Path path = Paths.get(UPLOADE_FOLDER + file.getOriginalFilename());
        System.out.println("Path : " + path);
        Path pathOut = Paths.get(UPLOADE_FOLDER + "new" + file.getOriginalFilename());
